...
REDIRECT_URI = os.getenv("REDIRECT_URI", "https://073c81bb-40d2-4392-b0c7-11856ca419e1.preview.emergentagent.com/api/auth/callback")
...
async def auth_callback(code: str, state: Optional[str] = None):
    try:
        ...
        if "access_token" not in result:
            ...
            frontend_url = os.getenv("FRONTEND_URL", "https://073c81bb-40d2-4392-b0c7-11856ca419e1.preview.emergentagent.com")
