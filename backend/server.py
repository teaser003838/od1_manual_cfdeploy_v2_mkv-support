...
REDIRECT_URI = os.getenv("REDIRECT_URI", "https://d67fcfe8-4f7d-436c-804c-688fbdb2b16f.preview.emergentagent.com/api/auth/callback")
...
async def auth_callback(code: str, state: Optional[str] = None):
    try:
        ...
        if "access_token" not in result:
            ...
            frontend_url = os.getenv("FRONTEND_URL", "https://d67fcfe8-4f7d-436c-804c-688fbdb2b16f.preview.emergentagent.com")
