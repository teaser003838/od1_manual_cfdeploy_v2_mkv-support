...
REDIRECT_URI = os.getenv("REDIRECT_URI", "https://213415b5-7b36-46f6-ae5b-80d9ba920744.preview.emergentagent.com/api/auth/callback")
...
async def auth_callback(code: str, state: Optional[str] = None):
    try:
        ...
        if "access_token" not in result:
            ...
            frontend_url = os.getenv("FRONTEND_URL", "https://213415b5-7b36-46f6-ae5b-80d9ba920744.preview.emergentagent.com")
