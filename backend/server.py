...
REDIRECT_URI = os.getenv("REDIRECT_URI", "https://9428e6fd-8402-4e81-a0d7-4266bd725b44.preview.emergentagent.com/api/auth/callback")
...
async def auth_callback(code: str, state: Optional[str] = None):
    try:
        ...
        if "access_token" not in result:
            ...
            frontend_url = os.getenv("FRONTEND_URL", "https://9428e6fd-8402-4e81-a0d7-4266bd725b44.preview.emergentagent.com")
