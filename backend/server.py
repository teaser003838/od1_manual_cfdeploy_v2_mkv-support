...
REDIRECT_URI = os.getenv("REDIRECT_URI", "https://e9a6f8fe-1147-4d8e-a669-299b536f0bb6.preview.emergentagent.com/api/auth/callback")
...
async def auth_callback(code: str, state: Optional[str] = None):
    try:
        ...
        if "access_token" not in result:
            ...
            frontend_url = os.getenv("FRONTEND_URL", "https://e9a6f8fe-1147-4d8e-a669-299b536f0bb6.preview.emergentagent.com")
